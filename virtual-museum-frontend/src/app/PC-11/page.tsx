...
const ModernArt = () => {
  ...
  return (
    ...
    className='PC__page'>
      ...
      height={0}
      width={0}
      src={'https://images.unsplash.com/photo-1518998053901-5348d3961a04?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2148&q=80'
      }
