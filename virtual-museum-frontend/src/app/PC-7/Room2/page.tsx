  ...
  return (
    ...
    className='PC__page'>
        ...
        <Image
            height={0}
            width={0}
            src={'https://images.unsplash.com/photo-1488952619802-0a3f502bab33?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1669&q=80'
            }
        ...
        <Box
            ...
            <IconButton
                sx={{color: 'white',
                    position:'absolute'}}
                size='large'
                onClick={() => router.push('/PC-7/Room4')}>
                <NorthEast
        ...
        <Box
            ...
            <IconButton
                sx={{color: 'white',
                    position:'absolute'}}
                size='large'
                onClick={() => router.push('/PC-7/Room3')}>
                <East
                    sx = {{fontSize: 'xxx-large'}}/>
            </IconButton>
        </Box>
