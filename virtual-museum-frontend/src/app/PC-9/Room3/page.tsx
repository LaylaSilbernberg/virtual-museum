...
import {ArrowForwardIos, NorthWest, SouthEast} from "@mui/icons-material";
    ...
    return (
        <main
            ...
            <Image
                height={0}
                width={0}
                src={'https://images.unsplash.com/photo-1615633949503-6ceb636b63c2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80'
                }
            ...
            <Box
                ...
                <IconButton
                    ...
                    size='large'
                    onClick={() => router.push('/PC-9/Room4')}>
                    <NorthWest
            ...
            <Box
                ...
                <IconButton
                    ...
                    size='large'
                    onClick={() => router.push('/PC-9/Room5')}>
                    <SouthEast
                        sx={{fontSize: 'xxx-large'}}/>
                </IconButton>
            </Box>
